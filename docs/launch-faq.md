...
## Is encryption at rest guaranteed in every build?

Not yet as a universal public guarantee. The codebase includes a SQLCipher path and Keychain integration, but build configuration is still being standardized. That is why the README no longer markets encryption at rest as a blanket promise across every build variant.
